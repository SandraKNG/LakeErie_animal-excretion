...
TDN.AbsData <- read.csv("TDN_AbsData_02DEC21.csv")[1:383,]
TDN.ChangeLog <- read.csv("TDN_ChangeLog_02DEC21.csv", colClasses = "character")
...
write.table(TDN.Output,file="TDN_Output_02DEC21.csv",row.names=FALSE,sep=",")
